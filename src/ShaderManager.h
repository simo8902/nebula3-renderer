...
public:
    ...
    std::shared_ptr<NDEVC::Graphics::Shader> GetShader(const std::string& name);
...
private:
    ...
    std::shared_ptr<NDEVC::Graphics::Shader> shaderProgram;

    std::unordered_map<std::string, std::shared_ptr<NDEVC::Graphics::Shader>> shaders;
